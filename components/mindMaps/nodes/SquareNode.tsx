...
export const SquareNode = ({ data, id }: NodeProps<NodeData>) => {
  ...
  return (
    ...
    >
      <div className="w-24 h-24 flex items-center justify-center bg-white border-2 border-gray-300">
        {isEditing ? (
          ...
          <p className="text-center break-words">{data.text ? data.text : t('PLACEHOLDER')}</p>
        )}
      </div>
    </NodeWrapper>
  );
