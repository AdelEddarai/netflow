...
import { updateTaskEmojiSchema } from '@/schema/updateTaskSchema';
...
export async function POST(request: Request) {
	...
	const result = updateTaskEmojiSchema.safeParse(body);
	...
	const { selectedEmoji, taskId, workspaceId } = result.data;
